...
import { styles } from './TrailorDetail.style';
...
const BookingCard = ({ item }) => {
  ...
  return (
    <View style={bk.card}>
      ...
      <View style={bk.right}>
        <Text style={[bk.status, isInProgress && bk.statusActive]}>
          {item.status}
        </Text>
